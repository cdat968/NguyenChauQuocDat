...
public class ResetPasswordTest extends TestBase {
	...
	public void TC10() {
		...
		Assert.assertEquals(actualIsDisplayedFormChangePassword, true, "Password Change Form is not displayed as expected");
		
		boolean actualIsDisplayedPasswordToken = resetPasswordPage.isDisplayResetToken();
		
		Assert.assertEquals(actualIsDisplayedPasswordToken, true, "The reset password token is not displayed as expected");
	...
	public void TC11() {
		...
		Assert.assertEquals(actualIsDisplayedForm, true, "Password Change Form is not displayed as expected");
